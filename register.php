...
<div class="session">
    ...
    <form action="register.php" method="POST" class="log-in" autocomplete="off"> 
      ...
      <div class="floating-label">
        <input placeholder="Address" type="text" name="address" id="address" autocomplete="off">
      ...
      <button type="submit" name="btnRegister">SignUp</button>
      <a href="login.php" class="discrete">Login</a>
